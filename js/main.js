...
/// FIX: Allow footer social links to open normally
document.querySelectorAll('.footer-site-social a').forEach(link => {
  link.addEventListener('click', function(e) {
    e.stopPropagation();   // prevent page scroll script from overriding
  });
});
